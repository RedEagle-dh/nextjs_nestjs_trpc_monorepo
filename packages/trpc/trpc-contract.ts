		...
		processAllTypes: publicProcedure
			.input(
				z.object({
					...
					myRecord: z.record(
						z.string().startsWith("key_"),
						z.boolean(),
					), // String-Keys, die mit "key_" beginnen, boolean values

					// Effekte (Generator sollte den Basistyp für Placeholder verwenden)
					myTransformedString: z
						.string()
						.transform((val) => val.length), // Input ist string, Output ist number
					myRefinedNumber: z
						.number()
						.refine((n) => n > 10, "Muss > 10 sein"),
			...
			.output(
				z.object({
					...
					selectedNativeNumericEnum: z.nativeEnum(
						TestNativeNumericEnum,
					),
			...
			.mutation(({ input, ctx }) => {
				return {
					receivedString: "PLACEHOLDER_STRING",
					processedNumber: 0,
					echoedBigInt: undefined,
					toggledBoolean: false,
					formattedDate: "PLACEHOLDER_STRING",
					confirmedNull: null,
					wasUndefined: false,
					literalEchoString: "HalloWelt",
					literalEchoNumber: 42,
					literalEchoBoolean: true,
					selectedStringEnum: "Apfel",
					selectedNativeNumericEnum: TestNativeNumericEnum.ADMIN,
					selectedNativeStringEnum: undefined,
					structuredObject: {
						originalId: "PLACEHOLDER_STRING",
						computedValue: "PLACEHOLDER_STRING",
						deepStatus: null,
					},
					stringArrayLength: 0,
					sumOfNumbers: 0,
					objectArrayCount: undefined,
					tupleValues: {
						val1: "PLACEHOLDER_STRING",
						val2: 0,
						val3: undefined,
					},
					optionalStringPresent: false,
					isNumberNull: false,
					defaultedString: "PLACEHOLDER_STRING",
					unionType: "PLACEHOLDER_STRING",
					discriminatedUnionEcho: {
						kind: "a",
						valueA: "PLACEHOLDER_STRING",
					},
					recordKeys: [],
					lazyNodeId: undefined,
					transformedStringLength: 0,
					refinedNumberPassthrough: 0,
				};
			}),
	}),
});
